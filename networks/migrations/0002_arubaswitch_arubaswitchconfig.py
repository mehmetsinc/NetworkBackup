    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('systemuser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arubaswitch', to='networks.systemuser')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ArubaSwitchConfig',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=250)),
                ('text', models.TextField()),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('arubaswitch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arubaswitchconfig', to='networks.arubaswitch')),
            ],
            options={
